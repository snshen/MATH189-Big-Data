...
if __name__ == '__main__':
	...
	# use np.random.shuffle(img) to shuffle an image img
	...
	# Decompose shuffle_img into U_s, S_s, V_s
	...
	for index in range(len(rank_list)):
		...
		# Use plt.imshow() to display images
		# Set cmap='Greys_r' in imshow() to display grey scale images
